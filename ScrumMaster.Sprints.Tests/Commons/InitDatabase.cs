...
namespace ScrumMaster.Sprints.Infrastructure.Tests.Commons
{
    internal static class InitDatabase
    {
        internal static ISprintDbContext InitialDatabase()
        {
            ...
            {
                new Sprint("TestName",DateTime.Now.AddDays(-10),DateTime.Now.AddDays(10),"TestCreatedBy",Guid.Parse("00000000-0000-0000-0000-000000000001"),Guid.Parse("00000000-0000-0000-0000-000000000001")){Id = Guid.Parse("00000000-0000-0000-0000-000000000002")},
            };
